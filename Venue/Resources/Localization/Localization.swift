...
enum L10n {
  ...
  enum Alert {
    ...
    enum LocationAlways {
      ...
      enum Design {
        /// Чтобы создать маршрут и определять местоположение, пожалуйста, выберите пункт «Всегда» в настройках геопозиции Venue.
      ...
      enum Driving {
        /// Чтобы стартовать по маршруту и определять местоположение, пожалуйста, выберите пункт «Всегда» в настройках геопозиции Venue.
        static var description: String {
      ...
      enum Routes {
        /// Чтобы увидеть треки поблизости и определять местоположение, пожалуйста, выберите пункт «Всегда» в настройках геопозиции Venue.
        static var description: String {
    ...
    enum LocationBase {
      /// Пожалуйста, разрешите доступ к геопозиции, чтобы Venue определял ваше местоположение.
      static var description: String {
    ...
    enum Notifications {
      /// Пожалуйста, разрешите Venue присылать вам полезные уведомления.
      static var description: String {
